                    ...
                    <div class="modal-body">
                     ...
                     <div id="regModal" class="regModal">
                      <form id="" action="Login" method="POST">
                        ...
                        <div class="div1"> <button class="btn btn-success" id="forReg" type="button" value="Submit">Submit</button>  <button class="btn btn-warning" type="reset" value="Reset">Reset</button></div>
                      </form>
                     </div>
                     </div>       
                     <br>
